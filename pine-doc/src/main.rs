...
fn write_doc(doc_parser: &LibVarParser) {
    let path = Path::new("/node/pine-lang/pine-doc/static/output/all_doc.html");
    ...
    let doc_path = Path::new("/node/pine-lang/pine-doc/static/output/doc.html");
    ...
    let doc_path = Path::new("/node/pine-lang/pine-doc/static/output/doc.json");
    let doc_display = doc_path.display();
